...
export const pies: Pie[] = [
  { name: "Mince Pie", radius: 20, assetKey: "mince" },
  { name: "Peach Tart", radius: 30, assetKey: "peach_tart" },
  { name: "Apple Cross", radius: 40, assetKey: "apple_cross" },
  { name: "Blueberry Pie", radius: 50, assetKey: "blueberry" },
  { name: "Cherry Pie", radius: 60, assetKey: "cherry_cross" },
  { name: "Chocolate Cream Pie", radius: 80, assetKey: "chocolate_cream" },
  { name: "Custard Pie", radius: 80, assetKey: "custard" },
  ...
  { name: "Chicken Pot Pie", radius: 135, assetKey: "chicken" },
  { name: "Pizza Pie", radius: 140, assetKey: "pizza_pie" },
]; 